...
@[simp] theorem carrier_bot : ((⊥ : Face P).carrier) = ∅ := rfl

@[simp] theorem coe_toConvexSet_bot : ((⊥ : Face P).toConvexSet : Set M) = ∅ := rfl

@[simp] theorem carrier_top : ((⊤ : Face P).carrier) = P := rfl

@[simp] theorem coe_toConvexSet_top : ((⊤ : Face P).toConvexSet : Set M) = P := rfl
