...
def rev (dual : PreDualityOperator α β) : PreDualityOperator β α where
  ...
  rev' := dual
  antimono' := dual.antimonoRev'
  antimonoRev' := dual.antimono'
  subset' := dual.subsetRev'
  subsetRev' := dual.subset'
  triple' := dual.tripleRev'
  tripleRev' := dual.triple'

lemma antimono (dual : PreDualityOperator α β) {s t : α} (hst : s ≤ t) :
    dual s ≤ dual t := dual.antimono' s t hst
...
instance : Coe (DualityOperator α β) (PreDualityOperator α β) := ⟨fun dual => {
  ...
  rev' := dual.rev'
  antimono' := dual.antimono'
  antimonoRev' := dual.antimonoRev'
...
lemma antimono (dual : DualityOperator α β) {s t : α} (hst : s ≤ t) :
    dual s ≤ dual t := dual.antimono' s t hst
